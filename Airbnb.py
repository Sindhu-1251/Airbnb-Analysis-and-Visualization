...
icon = Image.open(r"C:/Users/sindh/OneDrive/Desktop/Pro_img/Airbnb.webp")
st.set_page_config(page_title= "Airbnb Data Visualization | By Sindhu S",
                   page_icon= icon,
                   layout= "wide",
...
if selected == "Overview":
    tab1,tab2 = st.tabs([ f"**DATA**", f"**INSIGHTS**" ])
    ...
    with tab1:
        ...
        # DATAFRAME FORMAT
        if col1.button("Click to view Dataframe"):
